    ...
    <div className="h-screen flex items-center justify-center  ">
      <div className="rounded-md py-8 px-12 bg-slate-200">
        ...
        <form>
          ...
          <input
            className="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 mt-4"
            type="password"
            name="password"
          ...
          <br></br>
          <input
            className="px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mt-4"
            type="submit"
            value="Login"
            onClick={customLogin}
          />
        ...
        <button
          ...
          onClick={googleLogin}
        >
          <Image className="h-8 w-8 mr-2" src={googleimg} alt="GoogleImage" />
          Sign in with Google
        </button>
        <br></br>
